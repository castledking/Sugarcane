...
- **Classic version string** → `Bukkit.getBukkitVersion()` reports `26.3-R0.1-SNAPSHOT` rather than Paper
  26.x's `26.3.build.9-alpha`, so plugins that read it the way they always have find a Minecraft version
