...
- **Classic version string** → `Bukkit.getBukkitVersion()` reports `26.1.2-R0.1-SNAPSHOT` rather than Paper
  26.x's `26.1.2.build.9-stable`, so plugins that read it the way they always have find a Minecraft version
