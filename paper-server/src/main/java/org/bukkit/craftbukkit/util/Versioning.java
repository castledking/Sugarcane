...
public final class Versioning {
    ...
    static {
        ...
        // on '-', take the first token - gets "26.2.build.9" where it expects a Minecraft version, and then
        // fails its version lookup or reports nonsense (bStats charts, AdvancedEnchantments' bundled NBT-API
        // logging "Found Minecraft: 26.2.build.9"). Report "<mc>-R0.1-SNAPSHOT" instead, which is what every
